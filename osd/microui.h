...
#define MU_CONTAINERSTACK_SIZE  8
#define MU_CLIPSTACK_SIZE       8
#define MU_IDSTACK_SIZE         8
#define MU_LAYOUTSTACK_SIZE     8
#define MU_CONTAINERPOOL_SIZE   8
#define MU_TREENODEPOOL_SIZE    8
#define MU_MAX_WIDTHS           16
#define MU_REAL                 float
#define MU_REAL_FMT             "%.3g"
#define MU_SLIDER_FMT           "%.2f"
#define MU_MAX_FMT              32
...
typedef struct { short x, y; } mu_Vec2;
typedef struct { short x, y, w, h; } mu_Rect;
